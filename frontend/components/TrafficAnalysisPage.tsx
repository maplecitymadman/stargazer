  ...
  if (loading) {
    return (
      <div className="card rounded-lg p-8 text-center">
        ...
        <p className="text-[#71717a]">Loading ingress data...</p>
      </div>
    );
  }
  ...
  if (!topology?.ingress) {
    return (
      <div className="card rounded-lg p-8 text-center">
        ...
        <p className="text-[#71717a]">No ingress configuration found</p>
      </div>
    );
  }
...
function EgressView({ namespace }: { namespace?: string }) {
  ...
  if (loading) {
    return (
      <div className="card rounded-lg p-8 text-center">
        <Icon name="loading" className="text-[#3b82f6] animate-pulse text-4xl mb-4" />
        <p className="text-[#71717a]">Loading egress data...</p>
      </div>
    );
  }
  ...
  if (!topology?.egress) {
    return (
      <div className="card rounded-lg p-8 text-center">
        <Icon name="info" className="text-[#71717a] text-4xl mb-4" />
        <p className="text-[#71717a]">No egress configuration found</p>
      </div>
    );
  }
