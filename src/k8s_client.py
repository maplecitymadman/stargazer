...
class K8sClient:
    ...
    async def get_events(self, namespace: str = None) -> List[Dict[str, Any]]:
        ...
        try:
            if ns is None:
                events = self.v1.list_event_for_all_namespaces(field_selector="type!=Normal")
            else:
    ...
    async def get_deployments(self, namespace: str = None) -> List[Dict[str, Any]]:
        ...
        cache_key = f"deployments-{ns or 'all'}"
